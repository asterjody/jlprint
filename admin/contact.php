    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="contact.php">Kontak</a></li>
            ...
            <?php
              ...
              ?>
                <tr>
                    ...
                    <td>
                      <a type="button" class="btn btn-danger" href='forms/contact_delete_act.php?id=<?php echo $data['id']; ?> ' onclick="javascript: return confirm('Anda Yakin Ingin Menghapus Data?')"><i class='bx bx-trash' ></i></a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
