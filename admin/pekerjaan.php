    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="pekerjaan.php">Data Pekerjaan</a></li>
    ...
    <div class="container" data-aos="fade-up">
      <div class="col-12">
        ...
        <div class="text-center">
          <a class="btn btn-success" href="pekerjaan_add.php">Tambah Data</a>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td>
                    <a type="button" class="btn btn-warning" href='pekerjaan_edit.php?id=<?php echo $data['id']; ?> '><i class='bx bxs-edit'></i></a>
                    <a type="button" class="btn btn-danger" href='forms/pekerjaan_delete_act.php?id=<?php echo $data['id']; ?> ' onclick="javascript: return confirm('Anda Yakin Ingin Menghapus Data?')"><i class='bx bx-trash' ></i></a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
          ...
          <div class="text-center">
          <a class="btn btn-primary" href="forms/pekerjaan_laporan.php">Cetak Laporan</a>
        </div>
        </div>
