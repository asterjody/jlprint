    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="karyawan.php">Data Karyawan</a></li>
    ...
    <div class="container" data-aos="fade-up">
      <div class="col-12">
        ...
        <div class="text-center">
          <a class="btn btn-success" href="karyawan_add.php">Tambah Data</a>
        </div>
        ...
        <div class="row">
          <div class=" mt-5 mt-lg-0 flex align-items-center">
            ...
            <?php
                $no= 1;
                $query = mysqli_query($conn, 'SELECT * FROM `karyawan` ORDER BY `karyawan`.`tanggalmasuk` ASC');
              ...
              ?>
                <tr>
                    ...
                    <td>
                    <a type="button" class="btn btn-warning" href='karyawan_edit.php?id=<?php echo $data['id']; ?> '><i class='bx bxs-edit'></i></a>
                    <a type="button" class="btn btn-danger" href='forms/karyawan_delete_act.php?id=<?php echo $data['id']; ?> ' onclick="javascript: return confirm('Anda Yakin Ingin Menghapus Data?')"><i class='bx bx-trash' ></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
            ...
            <div class="text-center">
          <a class="btn btn-primary" href="forms/karyawan_laporan.php">Cetak Laporan</a>
        </div>
        </div>
